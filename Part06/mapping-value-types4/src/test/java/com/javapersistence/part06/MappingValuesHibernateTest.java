...
public class MappingValuesHibernateTest {
    ...
    private static SessionFactory createSessionFactory() {
        ...
        configuration.configure().addPackage("com.javapersistence.part06.converter").addAnnotatedClass(User.class).addAnnotatedClass(Item.class).addAnnotatedClass(Bid.class);
